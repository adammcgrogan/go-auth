...
// The request message for registering a new user.
...
// The request message for logging in a user.
...
// New request message for ListUsers (it's empty)
...
// New response message for ListUsers
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x12,
	0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x22, 0x31, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0xb8, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	(*ListUsersRequest)(nil),  // 4: auth.ListUsersRequest
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	4, // 2: auth.AuthService.ListUsers:input_type -> auth.ListUsersRequest
	1, // 3: auth.AuthService.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.AuthService.Login:output_type -> auth.LoginResponse
	5, // 5: auth.AuthService.ListUsers:output_type -> auth.ListUsersResponse
